    ...
    <div class="py-10 bg-[#EBF4F6] min-h-screen">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="bg-white rounded-3xl shadow-md border border-[#7AB2B2]/30 p-8">
                ...
                <form method="POST" action="{{ route('profil-admin.update') }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat"
                                rows="3"
                                class="w-full rounded-2xl border border-[#7AB2B2]/40 focus:ring-2 focus:ring-[#7AB2B2] focus:border-[#088395] px-4 py-2">{{ old('alamat', $user->profil->alamat ?? '') }}</textarea>
                        </div>
