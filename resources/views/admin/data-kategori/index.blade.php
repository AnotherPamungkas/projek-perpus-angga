<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{ $item->buku_count > 0 ? 'bg-green-100 text-green-600' : 'bg-green-100 text-green-600' }}">
                                ...
                                <td class="px-4 py-3 text-center space-x-2">
                                    ...
                                    <button disabled title="Kategori sedang digunakan"
                                        class="bg-gray-400 cursor-not-allowed text-white px-3 py-1 rounded-lg">
                                        Hapus
                                    </button>
                                    @else
                                    <form action="{{ route('admin.data-kategori.destroy', $item->id) }}" method="POST"
