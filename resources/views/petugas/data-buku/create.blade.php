    ...
    <div class="py-6">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow rounded">
                <form action="{{ route('petugas.data-buku.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="tahun_terbit" class="w-full border rounded px-3 py-2"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="jumlah_buku" class="w-full border rounded px-3 py-2" min="1"
                            required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="cover" class="w-full border rounded px-3 py-2" accept="image/*">
                    ...
                    <div class="flex justify-end space-x-2">
                        <a href="{{ route('petugas.data-buku.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded">
                            Kembali
                        </a>
