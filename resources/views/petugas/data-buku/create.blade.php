            ...
            <div class="bg-[#E8E8E8] border border-[#BBBFCA] rounded-3xl shadow-sm overflow-hidden">
                ...
                <div class="px-8 py-6 border-b border-[#BBBFCA] bg-[#F4F4F2]">
                    ...
                    <p class="text-sm text-[#3D3D3B]/60 mt-1">
                        Tambahkan data buku baru ke sistem perpustakaan.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi"
                                      rows="4"
                                      class="w-full rounded-2xl border border-[#BBBFCA] bg-white px-4 py-3 focus:ring-2 focus:ring-[#3D3D3B]">{{ old('deskripsi') }}</textarea>
                        </div>
